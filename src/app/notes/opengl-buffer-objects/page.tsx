...
export default function OpenglBufferObjects() {
  return (
    <div className="content-area article-flex">
      <ArticleTitle title="OpenGL Buffer Objects" date="Last Update: April 12, 2026" />
      ...
      <CodeBlock code={BASIC_DATA} lang="c" />
      <p>(TODO: Add picture to the right)</p>
      ...
      <CodeBlock code={STEP_2b_CODE} lang="c" />
      <p>(TODO: Add picture of vertices)</p>
      ...
      <CodeBlock code={STEP_2b_CODE} lang="c" />
      <p>(TODO: Show grid to the right with the vertices)</p>
      ...
      <CodeBlock code={STEP_3b_CODE} lang="c" />
      <p>(TODO: Show grid to the right with the vertices and triangles)</p>
