...
export default function Devlog() {
  return (
    <div className="content-area article-flex">
      <ArticleTitle title="Project Tracker" date="Last Update: August 26, 2026" />
      ...
      <ProgressTracker title="Phase 1: Crude Compositor" progress={100*9/14} items={[
        ...
        { status: 'done', name: "Pointer input", description: "Add support for mouse pointers." },
        { status: 'inprogress', name: "Use a third-party client", description: "Make use of an actual third-party application." },
