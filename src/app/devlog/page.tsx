...
export default function Devlog() {
  return (
    <div className="content-area article-flex">
      <ArticleTitle title="Project Tracker" date="Last Update: May 8, 2026" />
      ...
      <ProgressTracker title="Phase 1: Crude Compositor" progress={15} items={[
        ...
        { status: 'inprogress', name: "Wayland / input setup", description: "Set up Wayland globals, wire into display stack, add hooks for keyboard hotkeys." },
